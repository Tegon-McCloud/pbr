...
impl RenderTarget {
    ...
    pub fn new(width: u32, height: u32, fill_col: &Vector3<f32>) -> RenderTarget {
    ...
    pub fn pixels_par_mut<'a>(&'a mut self) -> impl ParallelIterator<Item=(Point2<f32>, &mut Vector3<f32>)> + 'a {
        self.buffer
            .par_iter_mut()
            .enumerate()
            .map(|(pos, px)| {
